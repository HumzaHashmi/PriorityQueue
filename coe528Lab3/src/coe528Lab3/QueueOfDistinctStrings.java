...
//AF(myQueue) = {myqueue.items[0] =q0, myQueue.items[items.size() - 1] = kn | for myQueue = {q0, q1..., qn}}
//
//
//
// The rep invariant is:
// b) Write the rep invariant here
//RI(myQueue) = returns true if n items are enqueued to myQueue and myQuea.items[i] =qi 
//qi is the number of which the item was enqueued to the queue
//
//
//the rep
...
// c) Write the code for the repOK() here
    ...
    QueueOfDistinctStrings myQueue = new QueueOfDistinctStrings();         
        ...
        return false;         
            ...
            myQueue.enqueue("ab"); //given from lab manual          
            myQueue.enqueue("cd");         
            myQueue.enqueue("ef");       
